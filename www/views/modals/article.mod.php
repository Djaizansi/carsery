            ...
            <div class="">
                ...
                <?php if($articles != null): ?>
                    <?php foreach ($articles as $article): ?>
                        <div class="article">
                            <p><b>Titre:</b> <a href="<?php echo Helpers::getUrl("Forum", "readarticle") ?>?id=<?= $article->getId() ?>"><?=$article->getTitle()?></a></p>
                            ...
                            <p class="text-right">
                                ...
                                <?php if($user->getStatus() == 'Admin'): ?>
                                    <a title="Suppression" href="#" data-modal-target="modal1" data-model="article" data-id="<?= $article->getId() ?>" class="myBtn"><i class="fas fa-trash-alt"></i></a>
                                <?php endif; ?>
                            </p>
                        </div>
                        <br>
