...
use carsery\mail\template\Contact;
...
class MailController
{
    public function mailAction()
    {
        if (Session::estConnecte()) {
            ...
            $mbox = imap_open("{imap-mail.outlook.com:993/ssl/novalidate-cert}Contact", "service.carsery@outlook.com", "projetannuel2020", OP_READONLY)
